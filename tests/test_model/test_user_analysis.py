...
def test_get_user_time_delta(test_dpmreport):
    ...
    assert user_time_delta.quartiles.iloc[0].total_seconds() == -2613
    assert user_time_delta.quartiles.iloc[1].total_seconds() == 26630
    assert round(user_time_delta.quartiles.iloc[2].total_seconds(), -1) == 63130
    assert user_time_delta.quartiles.iloc[3].total_seconds() == 127326
    assert user_time_delta.quartiles.iloc[4].total_seconds() == 347720
